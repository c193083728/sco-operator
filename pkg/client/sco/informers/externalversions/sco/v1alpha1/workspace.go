...
import (
	...
	v1alpha1 "github.com/sco1237896/sco-operator/pkg/client/sco/listers/sco/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ScoV1alpha1().Workspaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ScoV1alpha1().Workspaces(namespace).Watch(context.TODO(), options)
			},
		},
		&scov1alpha1.Workspace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workspaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&scov1alpha1.Workspace{}, f.defaultInformer)
}
