...
func (c *FakeWorkspaces) Apply(ctx context.Context, workspace *scov1alpha1.WorkspaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workspace, err error) {
	if workspace == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(workspacesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.Workspace{})
...
func (c *FakeWorkspaces) ApplyStatus(ctx context.Context, workspace *scov1alpha1.WorkspaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workspace, err error) {
	if workspace == nil {
		return nil, fmt.Errorf("workspace provided to Apply must not be nil")
	}
	data, err := json.Marshal(workspace)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(workspacesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha1.Workspace{})
