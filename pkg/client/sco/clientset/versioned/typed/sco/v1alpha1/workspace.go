...
type WorkspaceInterface interface {
	...
	Apply(ctx context.Context, workspace *scov1alpha1.WorkspaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workspace, err error)
	ApplyStatus(ctx context.Context, workspace *scov1alpha1.WorkspaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workspace, err error)
	WorkspaceExpansion
}
...
func newWorkspaces(c *ScoV1alpha1Client, namespace string) *workspaces {
	return &workspaces{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *workspaces) Apply(ctx context.Context, workspace *scov1alpha1.WorkspaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workspace, err error) {
	if workspace == nil {
...
func (c *workspaces) ApplyStatus(ctx context.Context, workspace *scov1alpha1.WorkspaceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Workspace, err error) {
	if workspace == nil {
		return nil, fmt.Errorf("workspace provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
